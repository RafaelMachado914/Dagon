...
public class Mesa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(carta002, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 30, -1, -1));
        ...
        getContentPane().add(carta001, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 30, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 255, 0));
        jLabel2.setText("I I I I I I I I I I");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 140, 20));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 100, 20));
        ...
        getContentPane().add(Acoes, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 230, 300, 40));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, -1, -1));
    ...
    public void receberCarta(){
        ...
        if (dano == 1){
            ...
            boss.setVida(jogador.getVida()+ 4);
            carta002.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CartaPolvo-export.png")));
        }
    }
